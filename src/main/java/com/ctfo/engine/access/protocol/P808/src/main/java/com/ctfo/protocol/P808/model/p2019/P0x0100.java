...
public class P0x0100 extends PModel implements Serializable {
	...
	/**
	 * 制造商 ID ,byte[11] ,5 个字节，终端制造商编码
	 */
	private String manufacturer;

	/**
	 * 终端型号 ，byte[30],20 个字节，此终端型号由制造商自行定义，位数不 足时，后补“0X00”。
	 */
	private String terminalModel;

	/**
	 * 终端 ID ,byte[30],7 个字节，由大写字母和数字组成，此终端 ID 由制 造商自行定义，位数不足时，后补“0X00”。
	 */
	private String terminaId;

	/**
	 * 车牌颜色 ,按照 JT/T679.7-2014 的 5.4.12。 未上牌时，取值为 0。
	 */
