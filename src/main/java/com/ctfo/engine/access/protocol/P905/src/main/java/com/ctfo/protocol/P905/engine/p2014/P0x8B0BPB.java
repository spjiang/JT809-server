...
import com.ctfo.protocol.P905.model.p2014.P0x8B0B;
import com.ctfo.protocol.support.exception.P905Exception;

/**
 * 中心解除报警消息编解码处理类，数据格式定义参考<code>P0x8B0B</code>
 *
 * @author fanya 2018年5月3日 下午5:15:26
 * @see
 * @version 1.0
 */
public class P0x8B0BPB implements IPassBody {
